      ...
      (unwind-protect
	   (progn
	     ...
	     (let* ((gcpl (h5pcreate +H5P-GROUP-CREATE+))
	       ...
	       (h5gclose (h5gcreate2 group "H" +H5P-DEFAULT+
				     +H5P-DEFAULT+ +H5P-DEFAULT+))
	       (h5gclose (h5gcreate2 group "D" +H5P-DEFAULT+
				     +H5P-DEFAULT+ +H5P-DEFAULT+))
	       (h5gclose (h5gcreate2 group "F" +H5P-DEFAULT+
				     +H5P-DEFAULT+ +H5P-DEFAULT+))
	       (h5gclose (h5gcreate2 group "5" +H5P-DEFAULT+
				     +H5P-DEFAULT+ +H5P-DEFAULT+))
	       ...
	       (let ((ginfo.nlinks (cffi:foreign-slot-value
				    ginfo-ptr '(:struct h5g-info-t) 'nlinks)))
