	 ...
	 (let*
	   ...
	   (dotimes (i *DIM0*)
	     (print (foreign-string-to-lisp
		     ...
		     (mem-ref (mem-aptr rdata '(:pointer :char) i)
			      '(:pointer :char)))))
